...
$(document).ready(function () {
    ...
    /* ===================================
     swiper slider
     ====================================== */
	var swiperFull = new Swiper('.new_visual', {
        loop: true,
        slidesPerView: 1,
        preventClicks: false,
        allowTouchMove: true,
...
$(document).ready(function() {
  $(".news_p").dotdotdot({
    ...
    height  : 48,    /*  선택. max-height를 지정한다. 만약 null이면 알아서 잰다. */
	...
	$(function(){
		$('#provision').click(function(){
			$('#provision_view').css('display','block');
		});
		$('#provision_view .head i').click(function(){
			$('#provision_view').css('display','none');
		});
		$('#provision2').click(function(){
			$('#provision_view2').css('display','block');
		});
		$('#provision_view2 .head i').click(function(){
			$('#provision_view2').css('display','none');
		});		
	});


	var swiper_12 = new Swiper('#tab_swiper', {
	slidesPerView: 'auto',
	spaceBetween: 10,
	loop: false,
	/*breakpoints: {
